...
const ButtonWithArrow = ({value, onClick}:{value:string, onClick?:React.MouseEventHandler<HTMLButtonElement>})=>{
    return (
        <button className="flex text-sm p-1 items-center gap-1 justify-between bg-blue-700 text-white rounded-full hover:bg-blue-600" type="submit" onClick={onClick}>
